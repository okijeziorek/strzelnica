...
function gro_dynamic_customize($customizer) {
    ...
    $fields = [
        ...
        'gro_booking_label' => ['Przycisk zewnętrznej rezerwacji', 'text'],
        'gro_booking_url' => ['Adres zewnętrznego systemu rezerwacji', 'url'],
    ...
    foreach ($fields as $id => $field) {
        ...
        if ('gro_offer_url' === $id) { $sanitize = 'gro_dynamic_sanitize_link'; }
        $defaults = gro_dynamic_defaults();
